                ...
                <tbody>
                    {
                        salesData.reverse().map((e, i) => {                            
                            ...
                            let biilDate = e.billDetail.billDate;
                            ...
                            return (
                                <tr key={i} >
                                    ...
                                    <td>{customerName}</td>
                                    <td>
                                        <p className='p-0 m-0'>{billNo}</p>
                                        <p className='p-0 m-0'>{biilDate}</p>
                                    </td>
                                    <td>{taxAble}</td>
                                    ...
                                    <td className='text-end'>
                                        <div className="dropdown">
                                            ...
                                            <ul className="dropdown-menu dropdown-menu-dark">
                                                ...
                                                <li><Link className="dropdown-item text-danger" id={i} to={"/sales"}>Edit</Link></li>
                                                <li className="dropdown-item text-danger" id={i} onClick={deleteFun}>Delete</li>
                                            </ul>
                                        </div>
